...
class ReffMekanismePenempatan extends Database
{
    ...
    {
        $findField = [
            "mekanisme_penempatan","keterangan"];
        return $findField;
    }
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_mekanisme_penempatan ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_mekanisme_penempatan (mekanisme_penempatan,keterangan) VALUES 
                                          (:mekanisme_penempatan,:keterangan)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_mekanisme_penempatan set mekanisme_penempatan=:mekanisme_penempatan,keterangan=:keterangan
                 WHERE id_reff_mekanisme_penempatan=:id_reff_mekanisme_penempatan";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_mekanisme_penempatan WHERE id_reff_mekanisme_penempatan=:id_reff_mekanisme_penempatan";
        echo $this->dbDataExecute($sql, $params['data']);
    }
