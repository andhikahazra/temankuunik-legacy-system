        ...
        MyApp.ajax(params).done(function(resp) {
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function(tpl) {
                    ...
                    for (i = 0; i < resp.result.length; i++) {
                        data2[i] = {};
                        data2[i].kode_kategori = nama = resp.result[i].kode_kategori;
                        data2[i].kode_aspek = nama = resp.result[i].kode_aspek;
                        data2[i].kode_sub_aspek = nama = resp.result[i].kode_sub_aspek;
                        data2[i].sub_aspek = nama = resp.result[i].sub_aspek;
                    }
