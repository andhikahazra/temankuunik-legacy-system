      ...
      // var Loadauditee = function () {
        ...
        console.log(resp.result);
            ...
            var data = resp.result;
                ...
                // console.log(data);
                var template = 
                 '<div style="text-align:center;font-size:12pt;font-weight:bold; text-transform: uppercase;">IPK III/4: LOWONGAN KERJA YANG TERDAFTAR, DITEMPATKAN DAN DIHAPUSKAN</div>'+ 
             ...
             for (var p = 0; p < data.length; p++) {
               ...
               template =template+
                ...
                $('.table-ipkempat').html(template,data);
