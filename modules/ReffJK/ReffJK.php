...
class ReffJK extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_jk ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_jk (jenis_kelamin) VALUES 
                                          (:jenis_kelamin)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_jk set jenis_kelamin=:jenis_kelamin
                 WHERE id_reff_jk=:id_reff_jk";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_jk WHERE id_reff_jk=:id_reff_jk";
        echo $this->dbDataExecute($sql, $params['data']);
    }
