...
class ReffJurusanPendidikan extends Database
{
    ...
    {
        $findField = [
            "id_reff_tingkat_pendidikan", "jurusan_pendidikan"
        ];
        return $findField;
    }
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $sql = 'SELECT jp.id_reff_jurusan_pendidikan, jp.id_reff_tingkat_pendidikan, jp.jurusan_pendidikan, jp.kode, tp.tingkat_pendidikan FROM reff_jurusan_pendidikan jp LEFT JOIN reff_tingkat_pendidikan tp USING (id_reff_tingkat_pendidikan)';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_jurusan_pendidikan ";
    ...
    public function PUBLIC_listPrint($return = false)
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $userId = $this->get_userId();
        $sql = 'SELECT * FROM reff_jurusan_pendidikan';
        if (isset($_POST['search']['value']) && $_POST['search']['value'] != '') {
            $keywords = strtolower($_POST['search']['value']);
            $findField = $this->findField();
            $criteria = $this->buildSqlSearchingCriteria($keywords, $findField);
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_jurusan_pendidikan (id_reff_tingkat_pendidikan,jurusan_pendidikan, kode) VALUES 
                                          (:id_reff_tingkat_pendidikan,:jurusan_pendidikan, :kode)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_jurusan_pendidikan set id_reff_tingkat_pendidikan=:id_reff_tingkat_pendidikan,jurusan_pendidikan=:jurusan_pendidikan, kode=:kode
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_jurusan_pendidikan WHERE id_reff_jurusan_pendidikan=:id_reff_jurusan_pendidikan";
        echo $this->dbDataExecute($sql, $params['data']);
    }
