...
(function() {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [{
                "data": "id_reff_jurusan_pendidikan",
                width: 5
            },
            {
            ...
            // { "data": "id_reff_jurusan_pendidikan" },
            { "data": "tingkat_pendidikan" }, { "data": "kode" }, { "data": "jurusan_pendidikan" },
        ],
        dom: 'Bfrtip',
        ...
        initComplete: function() {
            ...
            selectortable.on('click', '.btHapus', function() {
                index = $(this).data('index');
                dataRow = MyApp.$me.dataRow[index];
                konfirmasi = confirm('Apakah anda yakin ingin menghapus data ' + dataRow.jurusan_pendidikan);
                if (konfirmasi) {
                    hapus(dataRow);
                }
            });
