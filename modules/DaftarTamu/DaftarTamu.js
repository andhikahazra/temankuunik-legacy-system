...
(function() {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [{
            ...
            {"data": "nama"},{"data": "no_hp"},{"data": "instansi"},{"data": "keterangan_asal"},{"data": "tgl_input"},{"data": "tgl_edit"},
        ],
        dom: 'Bfrtip',
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function(tpl) {
                    ...
                    for (i = 0; i < resp.result.length; i++) {
                        data2[i]={};data2[i].id = nama=resp.result[i].id;data2[i].nama = nama=resp.result[i].nama;data2[i].no_hp = nama=resp.result[i].no_hp;data2[i].email = nama=resp.result[i].email;data2[i].instansi = nama=resp.result[i].instansi;data2[i].tgl_input = nama=resp.result[i].tgl_input;data2[i].tgl_edit = nama=resp.result[i].tgl_edit;
                    }
    ...
    var validator = $("#form_input").validate({
        ...
        rules: {
            ...
            // on the right side
            id: 'required',nama: 'required',no_hp: 'required',email: 'required',instansi: 'required',tgl_input: 'required',tgl_edit: 'required',
            kode: "required",
            lapangan_usaha: "required",
        },
        // Specify validation error messages
        messages: {
            id: 'Silahkan Isi Data Id',nama: 'Silahkan Isi Data Nama',no_hp: 'Silahkan Isi Data No Hp',email: 'Silahkan Isi Data Email',instansi: 'Silahkan Isi Data Instansi',tgl_input: 'Silahkan Isi Data Tgl Input',tgl_edit: 'Silahkan Isi Data Tgl Edit',
