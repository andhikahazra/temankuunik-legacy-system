...
class UnitLayanan extends Database
{
    ...
    public function PUBLIC_list($return=false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM unit_layanan ";
    ...
    public function PUBLIC_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into unit_layanan (unit_layanan,deskripsi) VALUES 
                                          (:unit_layanan,:deskripsi)";
    ...
    public function PUBLIC_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update unit_layanan set unit_layanan=:unit_layanan,deskripsi=:deskripsi
                 WHERE id_unit_layanan=:id_unit_layanan";
        echo $this->dbDataExecute($sql,$params['data']);
    }

    public function PUBLIC_delete(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from unit_layanan WHERE id_unit_layanan=:id_unit_layanan";
        echo $this->dbDataExecute($sql,$params['data']);
    }
