            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function(tpl) {
                    ...
                    for (i = 0; i < resp.result.length; i++) {
                        data2[i] = {};
                        data2[i].module_id = nama = resp.result[i].module_id;
                        data2[i].action_id = nama = resp.result[i].action_id;
                        data2[i].option = nama = resp.result[i].option;
                        data2[i].action = nama = resp.result[i].action;
                        data2[i].description = nama = resp.result[i].description;
                        data2[i].log = nama = resp.result[i].log;
                    }
