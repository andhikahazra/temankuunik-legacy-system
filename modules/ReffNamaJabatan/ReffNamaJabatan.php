...
class ReffNamaJabatan extends Database
{
    ...
    {
        $findField = [
            "id_reff_jabatan_kerja", "kode", "nama_jabatan"
        ];
        return $findField;
    }
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $sql = 'SELECT id_reff_nama_jabatan, id_reff_jabatan_kerja, kode_jabatan_kerja, nj.kode, nama_jabatan, jk.jabatan_kerja FROM reff_nama_jabatan nj LEFT JOIN reff_jabatan_kerja jk USING(id_reff_jabatan_kerja)';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_nama_jabatan ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_nama_jabatan (id_reff_jabatan_kerja,kode,nama_jabatan) VALUES 
                                          (:id_reff_jabatan_kerja,:kode,:nama_jabatan)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_nama_jabatan set id_reff_jabatan_kerja=:id_reff_jabatan_kerja,kode=:kode,nama_jabatan=:nama_jabatan
                 WHERE id_reff_nama_jabatan=:id_reff_nama_jabatan";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_nama_jabatan WHERE id_reff_nama_jabatan=:id_reff_nama_jabatan";
        echo $this->dbDataExecute($sql, $params['data']);
    }
