...
class Aduan extends Database
{
    ...
    public function PUBLIC_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update pendaftar set nik=:nik,nama=:nama,alamat=:alamat,email=:email,no_hp=:no_hp,input_date=:input_date,update_date=:update_date,user_update=:user_update,smartphone=:smartphone,minat=:minat
