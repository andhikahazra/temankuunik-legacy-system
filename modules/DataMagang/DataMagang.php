...
class DataMagang extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM magang ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $userUpdate = $userId = $this->get_userId();

        $sql = "INSERT into magang (nama,nim,tgl_input,tgl_update,jurusan,universitas,bidang,user_input,user_update,startDate,endDate) VALUES 
                                          (:nama,:nim,now(),now(),:jurusan,:universitas,:bidang,'$userId','$userUpdate',:startDate,:endDate)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update magang set nama=:nama,nim=:nim,tgl_input=:tgl_input,tgl_update=:tgl_update,universitas=:universitas,user_input=:user_input,user_update=:user_update
                 WHERE id=:id";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from magang WHERE id=:id";
        echo $this->dbDataExecute($sql, $params['data']);
    }
