...
(function() {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [{
            ...
            {"data": "nama"},{"data": "nim"},{"data":"jurusan"},{"data": "universitas"},{"data":"bidang"},{"data": "startDate"},{"data": "endDate"},
        ],
        dom: 'Bfrtip',
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function(tpl) {
                    ...
                    for (i = 0; i < resp.result.length; i++) {
                        data2[i]={};data2[i].id = nama=resp.result[i].id;data2[i].nama = nama=resp.result[i].nama;data2[i].nim = nama=resp.result[i].nim;data2[i].tgl_input = nama=resp.result[i].tgl_input;data2[i].tgl_update = nama=resp.result[i].tgl_update;data2[i].universitas = nama=resp.result[i].universitas;data2[i].user_input = nama=resp.result[i].user_input;data2[i].user_update = nama=resp.result[i].user_update;
                    }
    ...
    var validator = $("#form_input").validate({
        ...
        rules: {
            ...
            // on the right side
            id: 'required',nama: 'required',nim: 'required',tgl_input: 'required',tgl_update: 'required',universitas: 'required',user_input: 'required',user_update: 'required',
            kode: "required",
            lapangan_usaha: "required",
        },
        // Specify validation error messages
        messages: {
            id: 'Silahkan Isi Data Id',nama: 'Silahkan Isi Data Nama',nim: 'Silahkan Isi Data Nim',tgl_input: 'Silahkan Isi Data Tgl Input',tgl_update: 'Silahkan Isi Data Tgl Update',universitas: 'Silahkan Isi Data Universitas',user_input: 'Silahkan Isi Data User Input',user_update: 'Silahkan Isi Data User Update',
