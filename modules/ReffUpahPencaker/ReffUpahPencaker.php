...
class ReffUpahPencaker extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $sql = 'SELECT * FROM reff_upah_pencaker';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_upah_pencaker ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_upah_pencaker (upah_pencaker) VALUES 
                                          (:upah_pencaker)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_upah_pencaker set upah_pencaker=:upah_pencaker
                 WHERE id_upah_pencaker=:id_upah_pencaker";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_upah_pencaker WHERE id_upah_pencaker=:id_upah_pencaker";
        echo $this->dbDataExecute($sql, $params['data']);
    }
