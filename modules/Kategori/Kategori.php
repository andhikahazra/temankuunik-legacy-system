...
class Kategori extends Database
{
    ...
    private function findField() {
        $findField = [
            "kategori","deskripsi","id_unit_layanan"
        ];
        return $findField;
    }
    ...
    public function PUBLIC_list($return=false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM kategori ";
    ...
    public function PUBLIC_list_layanan()
    {
        $params = isset($_GET) ? $_GET : $_POST;
    ...
    public function PUBLIC_add(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into kategori (kategori,deskripsi,id_unit_layanan) VALUES 
                                          (:kategori,:deskripsi,:id_unit_layanan)";
    ...
    public function PUBLIC_update(){
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update kategori set kategori=:kategori,deskripsi=:deskripsi,id_unit_layanan=:id_unit_layanan
