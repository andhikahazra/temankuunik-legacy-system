...
class ReffJaminanSosial extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_jaminan_sosial ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_jaminan_sosial (jaminan_sosial) VALUES 
                                          (:jaminan_sosial)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_jaminan_sosial set jaminan_sosial=:jaminan_sosial
                 WHERE id_reff_jaminan_sosial=:id_reff_jaminan_sosial";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_jaminan_sosial WHERE id_reff_jaminan_sosial=:id_reff_jaminan_sosial";
        echo $this->dbDataExecute($sql, $params['data']);
    }
