...
class LogPesanwa extends Database
{
    ...
    {
        $findField = [
            "nomor_telepon","url","data","isi_pesan","user_id","user_insert","tgl_insert","status"];
        return $findField;
    }
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM log_pesanwa ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into log_pesanwa (nomor_telepon,url,data,isi_pesan,user_id,user_insert,tgl_insert,status) VALUES 
                                          (:nomor_telepon,:url,:data,:isi_pesan,:user_id,:user_insert,:tgl_insert,:status)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update log_pesanwa set nomor_telepon=:nomor_telepon,url=:url,data=:data,isi_pesan=:isi_pesan,user_id=:user_id,user_insert=:user_insert,tgl_insert=:tgl_insert,status=:status
                 WHERE id=:id";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from log_pesanwa WHERE id=:id";
        echo $this->dbDataExecute($sql, $params['data']);
    }
