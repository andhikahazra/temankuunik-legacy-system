...
(function() {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [{
          ...
          /*  {
            ...
            {"data": "data"},{"data": "user_id"},{"data": "tgl_insert"},
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function(tpl) {
                    ...
                    for (i = 0; i < resp.result.length; i++) {
                        data2[i]={};data2[i].id = nama=resp.result[i].id;data2[i].nomor_telepon = nama=resp.result[i].nomor_telepon;data2[i].url = nama=resp.result[i].url;data2[i].data = nama=resp.result[i].data;data2[i].isi_pesan = nama=resp.result[i].isi_pesan;data2[i].user_id = nama=resp.result[i].user_id;data2[i].user_insert = nama=resp.result[i].user_insert;data2[i].tgl_insert = nama=resp.result[i].tgl_insert;data2[i].status = nama=resp.result[i].status;
                    }
    ...
    var validator = $("#form_input").validate({
        ...
        rules: {
            ...
            // on the right side
            id: 'required',nomor_telepon: 'required',url: 'required',data: 'required',isi_pesan: 'required',user_id: 'required',user_insert: 'required',tgl_insert: 'required',status: 'required',
            kode: "required",
            lapangan_usaha: "required",
        },
        // Specify validation error messages
        messages: {
            id: 'Silahkan Isi Data Id',nomor_telepon: 'Silahkan Isi Data Nomor Telepon',url: 'Silahkan Isi Data Url',data: 'Silahkan Isi Data Data',isi_pesan: 'Silahkan Isi Data Isi Pesan',user_id: 'Silahkan Isi Data User Id',user_insert: 'Silahkan Isi Data User Insert',tgl_insert: 'Silahkan Isi Data Tgl Insert',status: 'Silahkan Isi Data Status',
