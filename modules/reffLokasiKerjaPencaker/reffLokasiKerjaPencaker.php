...
class reffLokasiKerjaPencaker extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $sql = 'SELECT * FROM reff_lokasi_kerja_pencaker';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_lokasi_kerja_pencaker ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_lokasi_kerja_pencaker (lokasi_kerja_pencaker) VALUES 
                                          (:lokasi_kerja_pencaker)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_lokasi_kerja_pencaker set lokasi_kerja_pencaker=:lokasi_kerja_pencaker
                 WHERE id_reff_lokasi_kerja_pencaker=:id_reff_lokasi_kerja_pencaker";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_lokasi_kerja_pencaker WHERE id_reff_lokasi_kerja_pencaker=:id_reff_lokasi_kerja_pencaker";
        echo $this->dbDataExecute($sql, $params['data']);
    }
