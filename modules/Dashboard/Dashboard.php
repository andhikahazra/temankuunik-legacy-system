...
class Dashboard extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $sql = 'SELECT * FROM group_has_users';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM group_has_users ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into group_has_users (group_id,user_id) VALUES 
                                          (:group_id,:user_id)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update group_has_users set group_id=:group_id,user_id=:user_id
                 WHERE id=:id";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from group_has_users WHERE id=:id";
        echo $this->dbDataExecute($sql, $params['data']);
    }
