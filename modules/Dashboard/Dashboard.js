...
(function() {
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function(tpl) {
                    ...
                    for (i = 0; i < resp.result.length; i++) {
                        data2[i]={};data2[i].id = nama=resp.result[i].id;data2[i].group_id = nama=resp.result[i].group_id;data2[i].user_id = nama=resp.result[i].user_id;
                    }
    ...
    var validator = $("#form_input").validate({
        ...
        rules: {
            ...
            // on the right side
            id: 'required',group_id: 'required',user_id: 'required',
            kode: "required",
            lapangan_usaha: "required",
        },
        // Specify validation error messages
        messages: {
            id: 'Silahkan Isi Data Id',group_id: 'Silahkan Isi Data Group Id',user_id: 'Silahkan Isi Data User Id',
