            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function(tpl) {
                    ...
                    for (i = 0; i < resp.result.length; i++) {
                        data2[i] = {};
                        data2[i].id_data_pilah_kolom = nama = resp.result[i].id_data_pilah_kolom;
                        data2[i].kode_data_pilah = nama = resp.result[i].kode_data_pilah;
                        data2[i].header_kolom = nama = resp.result[i].header_kolom;
                        data2[i].nama_kolom = nama = resp.result[i].nama_kolom;
                        data2[i].kode_kolom = nama = resp.result[i].kode_kolom;
                        data2[i].jml_l = nama = resp.result[i].jml_l;
                        data2[i].jml_p = nama = resp.result[i].jml_p;
                        data2[i].jml_lp = nama = resp.result[i].jml_lp;
                        data2[i].tipe_kolom = nama = resp.result[i].tipe_kolom;
                        data2[i].aktif = nama = resp.result[i].aktif;
                    }
