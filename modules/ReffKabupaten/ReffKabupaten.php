...
class ReffKabupaten extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        // $sql = 'SELECT * FROM reff_kabupaten';
        $sql = 'SELECT d.*, k.provinsi FROM reff_kabupaten d LEFT JOIN reff_provinsi k USING (id_reff_provinsi)';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_kabupaten ";
    ...
    public function PUBLIC_add()
    {
        ...
        $sql = "INSERT INTO reff_kabupaten (id_reff_provinsi,
                                            kabupaten,
                                            user_input,
                                           tgl_input) 
                                            VALUES 
      ...
      public function PUBLIC_update()
    {
        ...
        $sql = "UPDATE reff_kabupaten set id_reff_provinsi=:id_reff_provinsi,
                                          kabupaten=:kabupaten,
                                          user_update='".$user."',
                                          tgl_update =NOW()
                 WHERE id_reff_kabupaten=:id_reff_kabupaten";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "DELETE FROM reff_kabupaten WHERE id_reff_kabupaten=:id_reff_kabupaten";
        echo $this->dbDataExecute($sql, $params['data']);
    }
