      ...
      // var Loadauditee = function () {
        ...
        // console.log(resp.result);
            ...
            var data = resp.result;
                ...
                console.log(data);
                var template = 
                 '<div style="text-align:center;font-size:12pt;font-weight:bold; text-transform: uppercase;">IPK III/7: PENEMPATAN PENCARI KERJA MENURUT JENIS ANTAR KERJA</div>'+ 
                 '<div style="text-align:center;font-size:12pt;font-weight:bold; text-transform: uppercase;">TINGKAT PENDIDIKAN PENCARI KERJA DAN JENIS KELAMIN DIKOTA/KABUPATEN SLEMAN</div>'+
                        ...
                        '<table style="border-collapse: collapse; width: 100%; height: 90px;" border="1">'+
                            '<thead>'+
                                '<tr>'+
                                        ...
                                        '<td rowspan="3" style="font-weight:bold;text-align:center;">I. Tingkat Pendidikan Pencari Kerja yang ditempatkan</td>'+
                        ...
                        for (var p = 0; p < data.length; p++) {
                              ...
                              template =template+
                                '<tr>'+
                                        ...
                                        '<td>'+data[p].tingkat_pendidikan+'</td>'+
                ...
                $('.table-ipktujuh').html(template,data);
               ...
               var template = 
                 ...
                 '<div style="text-align:center;font-size:12pt;font-weight:bold; text-transform: uppercase;">BULAN '+arrbulan[bulan]+' '+tahun+'</div>'+
                        ...
                        '<table style="border-collapse: collapse; width: 100%; height: 90px;" border="1">'+
                            '<thead>'+
                                '<tr>'+
                                        '<td rowspan="3" style="font-weight:bold;text-align:center;vertical-align:middle">No</td>'+
                                        '<td rowspan="3" style="font-weight:bold;text-align:center;vertical-align:middle">I. Tingkat Pendidikan Pencari Kerja yang ditempatkan</td>'+
                                        '<td colspan="9" style="font-weight:bold;text-align:center;">Jenis Antar Kerja</td>'+
                                        '<td colspan="3" rowspan="2" style="font-weight:bold;text-align:center;vertical-align:middle">Jumlah</td>'+
                                '</tr>'+
                                '<tr>'+
                                        '<td colspan="3" style="font-weight:bold;text-align:center;">AKL</td>'+
                                        '<td colspan="3" style="font-weight:bold;text-align:center;">AKAD</td>'+
