...
class ReffBahasaAsing extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $sql = 'SELECT * FROM reff_bahasa_asing';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_bahasa_asing ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_bahasa_asing (bahasa_asing) VALUES 
                                          (:bahasa_asing)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_bahasa_asing set bahasa_asing=:bahasa_asing
                 WHERE id_reff_bahasa_asing=:id_reff_bahasa_asing";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_bahasa_asing WHERE id_reff_bahasa_asing=:id_reff_bahasa_asing";
        echo $this->dbDataExecute($sql, $params['data']);
    }
