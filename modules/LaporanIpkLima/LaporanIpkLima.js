      ...
      // var Loadauditee = function () {
        ...
        console.log(resp.result);
            ...
            var data = resp.result;
                ...
                // console.log(data);
                var template = 
                 '<div style="text-align:center;font-size:12pt;font-weight:bold; text-transform: uppercase;">IPK III/5: LOWONGAN KERJA YANG TERDAFTAR, DITEMPATKAN DAN DIHAPUSKAN</div>'+ 
             ...
             for (var p = 0; p < data.length; p++) {
              ...
              template =template+
                ...
                $('.table-ipklima').html(template,data);
            ...
            var data = resp.result;
                ...
                var template = 
                 ...
                 '<br/>'+
                        ...
                        '<thead>'+
                            '<tr>'+
                                '<td rowspan="2" style="vertical-align:top;text-align:center;font-weight:bold;">Kode</td>'+
                                '<td rowspan="2" style="vertical-align:top;text-align:center;font-weight:bold;">Jabatan</td>'+
                                '<td colspan="2" style="text-align:center;font-weight:bold;">Sisa akhir bulan lalu</td>'+
                                '<td colspan="2" style="text-align:center;font-weight:bold;">Lowongan terdaftar bulan ini</td>'+
                                '<td colspan="2" style="text-align:center;font-weight:bold;">Lowongan ditempatkan bulan ini</td>'+
                                '<td colspan="2" style="text-align:center;font-weight:bold;">Lowongan dihapuskan bulan ini</td>'+
