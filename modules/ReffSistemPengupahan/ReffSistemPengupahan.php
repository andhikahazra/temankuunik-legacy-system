...
class ReffSistemPengupahan extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_sistem_pengupahan ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_sistem_pengupahan (sistem_pengupahan) VALUES 
                                          (:sistem_pengupahan)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_sistem_pengupahan set sistem_pengupahan=:sistem_pengupahan
                 WHERE id_reff_sistem_pengupahan=:id_reff_sistem_pengupahan";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_sistem_pengupahan WHERE id_reff_sistem_pengupahan=:id_reff_sistem_pengupahan";
        echo $this->dbDataExecute($sql, $params['data']);
    }
