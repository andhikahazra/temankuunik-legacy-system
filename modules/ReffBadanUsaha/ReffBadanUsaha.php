...
class ReffBadanUsaha extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_badan_usaha ";
    ...
    public function PUBLIC_add()
    {
        ...
        $sql = "INSERT INTO reff_badan_usaha (nama_badan_usaha,
                                             tgl_input,
                                             user_input)
                                    VALUES (:nama_badan_usaha,
                                             NOW(),
                                             '".$user."')";
    ...
    public function PUBLIC_update()
    {
        ...
        $sql = "UPDATE reff_badan_usaha SET
                                nama_badan_usaha=:nama_badan_usaha,
                                tgl_update=NOW(),
                                user_update='".$user."'
                 WHERE id_reff_badan_usaha=:id_reff_badan_usaha";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "DELETE FROM reff_badan_usaha WHERE id_reff_badan_usaha=:id_reff_badan_usaha";
        echo $this->dbDataExecute($sql, $params['data']);
    }
