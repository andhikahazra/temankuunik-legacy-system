...
class ReffJabatanKerja extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $sql = 'SELECT * FROM reff_jabatan_kerja';
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_jabatan_kerja ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_jabatan_kerja (kode,jabatan_kerja) VALUES 
                                          (:kode,:jabatan_kerja)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_jabatan_kerja set kode=:kode,jabatan_kerja=:jabatan_kerja
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_jabatan_kerja WHERE id_reff_jabatan_kerja=:id_reff_jabatan_kerja";
        echo $this->dbDataExecute($sql, $params['data']);
    }
