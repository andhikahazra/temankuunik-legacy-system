...
class ReffLapanganUsaha extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_lapangan_usaha ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_lapangan_usaha (lapangan_usaha,kode) VALUES 
                                          (:lapangan_usaha,:kode)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_lapangan_usaha set lapangan_usaha=:lapangan_usaha,kode=:kode
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_lapangan_usaha WHERE id_reff_lapangan_usaha=:id_reff_lapangan_usaha";
        echo $this->dbDataExecute($sql, $params['data']);
    }
