...
(function() {
    ...
    MyApp.$me.selectorTable = $('#datatable_fixed_column').DataTable({
        ...
        "columns": [{
                "data": "id_reff_status_hubungan_kerja",
                width: 5
            },
            {
            ...
            if (resp.success) {
                MyApp.loadModuleFile('template/tpl_pdf.html', function(tpl) {
                    ...
                    for (i = 0; i < resp.result.length; i++) {
                        data2[i] = {};
                        data2[i].id_reff_status_hubungan_kerja = nama = resp.result[i].id_reff_status_hubungan_kerja;
...
//# sourceURL=ReffStatusHubunganKerja.js