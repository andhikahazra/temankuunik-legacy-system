...
class ReffStatusHubunganKerja extends Database
{
    ...
    public function PUBLIC_list($return = false)
    {
        ...
        $array = array();
        $sqlCount = "SELECT count(*) FROM reff_status_hubungan_kerja ";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "insert into reff_status_hubungan_kerja (status_hubungan_kerja) VALUES 
                                          (:status_hubungan_kerja)";
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "update reff_status_hubungan_kerja set status_hubungan_kerja=:status_hubungan_kerja
                 WHERE id_reff_status_hubungan_kerja=:id_reff_status_hubungan_kerja";
        echo $this->dbDataExecute($sql, $params['data']);
    }
    ...
    {
        $params = isset($_GET) ? $_GET : $_POST;
        $sql = "delete from reff_status_hubungan_kerja WHERE id_reff_status_hubungan_kerja=:id_reff_status_hubungan_kerja";
        echo $this->dbDataExecute($sql, $params['data']);
    }
